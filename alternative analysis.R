...
for (perc in relevant_percentages){
  ...
  eplot(dip.fdat.i[,1:2], dip.l, centroid = T, xlab ='F1 (Hz)', ylab='F2 (Hz)',
        ylim = c(0,3000),
        main=paste('Diphtongs ellipses for T = ', perc))
}
...
for (perc in relevant_percentages){
  ...
  eplot(m.fdat.i[,1:2], m.l, centroid = T, xlab ='F1 (Hz)', ylab='F2 (Hz)',
        ylim = c(300,2500),
        main=paste('Diphtongs ellipses for males for T = ', perc))
}
...
for (perc in relevant_percentages){
  ...
  eplot(f.fdat.i[,1:2], f.l, centroid = T, xlab ='F1 (Hz)', ylab='F2 (Hz)',
        ylim = c(0,3200),
        main=paste('Diphtongs ellipses for females for T = ', perc))
}
...
for (perc in relevant_percentages){
  ...
  eplot(aI.fdat.i[,1:2], ifelse(aI.spkr == '67', 'M','F'), centroid = T, xlab ='F1 (Hz)', ylab='F2 (Hz)',
        main=paste('Diphtongs ellipses for aI for T = ', perc))
}
...
for (perc in relevant_percentages){
  ...
  eplot(aU.fdat.i[,1:2], ifelse(aU.spkr == '67', 'M','F'), centroid = T, xlab ='F1 (Hz)', ylab='F2 (Hz)',
        main=paste('Diphtongs ellipses for aU for T = ', perc))
}
...
for (perc in relevant_percentages){
  ...
  eplot(OY.fdat.i[,1:2], ifelse(OY.spkr == '67', 'M','F'), centroid = T, xlab ='F1 (Hz)', ylab='F2 (Hz)',
        main=paste('Diphtongs ellipses for OY for T = ', perc))
}

### T1, T2 for males
x11()
dplot(m.fdat[,1:2], m.l, normalise = T, xlab ='F1 (Hz)', ylab='F2 (Hz)',
      main=paste('Overall diphtongs ellipses for male'))
